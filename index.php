...
<div class="container">
  ...
  <p>
    Quick links:
    <a href="/assessment_beginner/pages/clients_add.php" class="btn-primary">Add Client</a>
    <a href="/assessment_beginner/pages/bookings_create.php" class="btn-primary">Create Booking</a>
  </p>
</div>
